...
void* main_surelan( void* args )
{
	...
	if (!parObj.getparint("nr",&nr)) nr = 51;
	if (!parObj.getparfloat("dr",&dr)) dr = 0.01;
	if (!parObj.getparfloat("fr",&fr)) fr = -0.25;
