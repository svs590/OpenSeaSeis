...
void* main_sudatumfd( void* args )
{
   ...
   if (!parObj.getparint("nt",&nt)) throw cseis_geolib::csException("must specify nt");
   ...
   if (!parObj.getparint("nsx",&nsx)) throw cseis_geolib::csException("must specify nsx");
   if (!parObj.getparfloat("v",&v)) v=1000.0;
   if (!parObj.getparfloat("dz",&dz)) throw cseis_geolib::csException("must specify dz");
   if (!parObj.getparfloat("x_0",&x_0)) throw cseis_geolib::csException("must specify x_0");
   if (!parObj.getparint("buff",&buff)) throw cseis_geolib::csException("must specify buff");
   if (!parObj.getparint("tap_len",&tap_len)) throw cseis_geolib::csException("must specify tap_len");
   if (!parObj.getparint("mx",&mx)) throw cseis_geolib::csException("must specify mx");
   if (!parObj.getparint("mz",&mz)) throw cseis_geolib::csException("must specify mz");
   if (!parObj.getparstring("vfile1",&vfile1)) throw cseis_geolib::csException("must specify vfile1");
   if (!parObj.getparstring("vfile2",&vfile2)) throw cseis_geolib::csException("must specify vfile2");
