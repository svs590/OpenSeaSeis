...
void* main_sultt( void* args )
{
	...
	****************************************************************/		
	...
	if (!parObj.getparstring("outS22",&outS22))
		outS22="S22_out";
	if (!parObj.getparstring("alpha", &alpha))
		alpha="alpha";
	if (!parObj.getparstring("theta", &theta))
		theta="theta";
	if (!parObj.getparstring("gamma", &gamma))
		gamma="gamma";
	...
	if(!parObj.getparint("wl", &wl)) wl=3;
	if(!parObj.getparint("mode", &mode)) mode=2;
        parObj.checkpars();
